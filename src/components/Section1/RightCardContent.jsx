...
const RightCardContent = (props) => {
  return (
    <div className="h-full w-full absolute top-0 left-0 p-8 flex flex-col justify-between">
      ...
      <div>
        <p className=" text-shadow-2xs text-md text-white mb-10 leading-relaxed">
        ...
        <div className="flex justify-between">
          <button
            ...
            className=" text-white rounded-full px-8 py-2 font-medium"
          >
            {props.tag}
          </button>
          <button
            style={{ backgroundColor: props.color }}
            className=" text-white rounded-full px-3 py-2 font-medium"
          >
